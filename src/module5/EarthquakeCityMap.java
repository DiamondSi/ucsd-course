...
//        printQuakes();
    ...
    /**
     * If there is a marker under the cursor, and lastClicked is null
     * set the lastClicked to be the first marker found under the cursor
     *
     * @param markers collection for check
     */
            ...
            if (!marker.isHidden() && marker.isInside(map, mouseX, mouseY) && lastClicked == null) {
                ...
                if (lastClicked instanceof EarthquakeMarker) {
                    ...
                    for (Marker city : cityMarkers) {
                        if (lastClicked.getDistanceTo(city.getLocation()) <= threat) {
                    ...
                    for (Marker quake : quakeMarkers) {
                        ...
                        if (lastClicked.getDistanceTo(quake.getLocation()) <= threat) {
